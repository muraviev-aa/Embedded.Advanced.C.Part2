...
* [Тестирование кода на языке C с использованием GoogleTest](#title6)

* [Тестирование кода на языке C с использованием Unity](#title8)
...
├── CMakeLists.txt              # Файл конфигурации сборки проекта
│
├── /resources                  # Папка с файлами доп. ресурсов (SQLite, файл БД) 
│      
├── /include                    # Папка для заголовочных файлов
│   ├── area.h                  # Заголовочный файл с прототипами функций
│   ├── math.h                  # Заголовочный файл с прототипами функций
│   ├── test_area.h             # Заголовочный файл с прототипами тестов
│   └── test_math.h             # Заголовочный файл с прототипами тестов
│
├── /src                        # Папка с исходными файлами реализации
│   ├── CMakeLists.txt          # Файл конфигурации сборки проекта
│   ├── area.c                  # Файл с реализациями функций
│   ├── math.c                  # Файл с реализациями функций
│   └── main.c                  # Точка входа в программу
│
└── /tests                      # Папка с тестами
    ├── CMakeLists.txt          # Файл конфигурации сборки тестов
    ├── main_test.c             # Основной файл для запуска тестов
    ├── test_area.c             # Основной файл для запуска тестов
    └── test_math.c             # Файл с тестами для функций из math.c
```
